...
\begin{figure}[!hb]
  \centering
  \includegraphics[width=1\textwidth]{./fig/organograma-cercomp-completo.png}
  \caption[Proposta de Organograma do CERCOMP.]{Proposta de Organograma do CERCOMP. Fonte:~\url{https://cercomp.ufg.br}.}
...
\begin{enumerate}
  ...
  \item Avaliar e sugerir alternativas para o aprimoramento do Catálogo de Serviços de TI, considerando possibilidades de automatização e integração com a ferramenta de gerenciamento de chamados adotada pela instituição.
\end{enumerate}

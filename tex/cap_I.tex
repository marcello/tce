...
Anualmente, as atividades da UFG são objeto de acompanhamento e auditoria dos órgãos de controle, tais como TCU e CGU. O Relatório de Gestão 2018 \cite{RelatorioGestao}, apresentado junto à CGU, possui uma seção (Anexo G) dedicada à ``Gestão da tecnologia da informação da unidade jurisdicionada'', a qual tem por objetivo colher informações sobre a governança e gestão de TI, assim como dos serviços de TI oferecidos aos cidadãos.

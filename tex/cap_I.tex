...
Além das dificuldades observadas no encaminhamento e atendimento de solicitações de serviços de TI, um outro fator tem se tornado determinante ao desenvolvimento de ações para o gerenciamento de serviços de TI do CERCOMP: o atendimento às exigências e determinações provenientes das atividades de fiscalização e acompanhamento de órgãos de controle e ministérios.

Anualmente, as atividades da UFG são objeto de auditoria dos órgãos de controle, tais como TCU e CGU. O Relatório de Gestão 2018 \cite{RelatorioGestao}, apresentado junto à CGU, possui uma seção (Anexo G) dedicada à ``Gestão da tecnologia da informação da unidade jurisdicionada'', a qual tem por objetivo colher informações sobre a governança e gestão de TI, assim como dos serviços de TI oferecidos aos cidadãos.

A UFG, enquanto órgão da administração federal indireta, na condição de autarquia, integra o Sistema de Administração dos Recursos de Tecnologia da Informação (SISP) do atual Ministério da Economia. O SISP é um sistema instituído com o objetivo de gerir os recursos de TI da Administração Pública Federal Direta, Autárquica e Fundacional e, para tanto, estabelece um conjunto de diretrizes e normas a serem seguidas pelo órgãos vinculados.
...
Dessa forma, mais do que uma necessidade entende-se que a disponibilização do Catálogo de Serviços de TI é uma oportunidade para aprimorar a qualidade dos serviços de TI oferecidos pelo CERCOMP, de forma a atender tanto as diretrizes e exigências dos órgãos de controle como os objetivos e metas institucionais estabelecidos para a área.

Assim, diante dos argumentos apresentados acima, entende-se que esses fatores constituem-se como os principais elementos motivadores para escolha do tema proposto e a realização do projeto técnico.
